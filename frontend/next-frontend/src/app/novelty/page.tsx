...
import NoveltyClient from "./client";
...
export default async function NoveltyPage() {
  ...
  try {
    ...
    return <NoveltyClient noveltyItems={goodsData} />;
  } catch (error) {
    console.error("API request error:", error);
    return (
      <div className="container mx-auto px-4 py-8 text-center">
        <h1 className="text-3xl font-bold mb-4">Novelty Items</h1>
